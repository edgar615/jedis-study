...
public class LimitTest2 {
  public static void main(String[] args) throws InterruptedException, IOException {
    ...
    System.out.println(new LimitTest2().accessLimit("192.168.1.100", 2, 3, jedis));
    System.out.println(new LimitTest2().accessLimit("192.168.1.100", 2, 3, jedis));
    System.out.println(new LimitTest2().accessLimit("192.168.1.100", 2, 3, jedis));
  ...
  private boolean accessLimit(String ip, int limit, int timeout,
    ...
    return 1 == (Long) connection.eval(loadScriptString("single_count.lua"), keys, argv);
  }

  // 加载Lua代码
  private String loadScriptString(String fileName) throws IOException {
    Reader reader =
            new InputStreamReader(LimitTest2.class.getClassLoader().getResourceAsStream(fileName));
